...
~characterName="Профессор Леший"
~characterExpression = 0
– Верно, - несколько сварливо подтвердил тот. - Можете сесть на место, но больше что б не опаздывали.
...
~characterName="Профессор Леший"
~characterExpression = 0
– Так на следующий урок подготовить доклад о полезных свойствах малины и чем можно ее заменить в снадобьях, - записывая домашнее задание на доске, сообщил тот. - Можете быть свободны.
